...
class Admin {
	...
	Scanner sc=new Scanner(System.in);
	 ...
	 {      System.out.println("TheatreNo    TheatreName  MovieName         No.OfTickets    Ticket Cost");
...
//	 }
	 ...
	 public void theatreList(){
	    	{  
	    		...
	    		tlist.add(new Manager((byte)2,"Sathyam Cinemas   ","VTK             ",200, 150)); 
	    		tlist.add(new Manager((byte)3,"Kamala Theatre    ","Thiruchitrambalam",150, 140));
	    		tlist.add(new Manager((byte)4,"Udhayam Theatre   ","Naane Varuven   ",150, 170));
	    		tlist.add(new Manager((byte)5,"INOX Cinemas      ","Cobra           ",100, 130));
	    		tlist.add(new Manager((byte)6,"Rohini Cinemas    ","Gulu gulu       ",150, 110));
	    		tlist.add(new Manager((byte)7,"Mayajaal          "," Natachathiram Nagaragirathu     ",150, 110));
