...
void plus(int a[] , int val , int val1, int val2, String c1 ) {
	...
	else if(val + (a[2] - a[3]) == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "+" + "(" + a[2] + "-" + a[3] + ")";
	}
	else if(val + (a[2] * a[3]) == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "+" + "(" + a[2] + "*" + a[3] + ")";
	}
	else if(a[2] >= a[3] && a[2] % a[3] == 0 && val + (a[2] / a[3]) == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "+" + "(" + a[2] + "/" + a[3] + ")";
	}
	
	else if(val + x == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "+" + "(" + a[2] + "" + a[3] + ")";
	}
...
int x = (a[2] * 10) + a[3];
	...
	else if(a[2] > a[3] && val >= (a[2] - a[3]) && val % (a[2] - a[3]) == 0 && val / (a[2] - a[3]) == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "/" + "(" + a[2] + "-" + a[3] + ")";
	}
	else if(val >= (a[2] * a[3]) && val % (a[2] * a[3]) == 0 && val / (a[2] * a[3]) == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "/" + "(" + a[2] + "*" + a[3] + ")";
	}
	else if(a[2] >= a[3] && a[2] % a[3] == 0 && val >= (a[2] / a[3]) && val % (a[2] / a[3]) == 0 && val / (a[2] / a[3]) == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "/" + "(" + a[2] + "/" + a[3] + ")";
	}
	
	else if(val >= x && val % x == 0 && val / x == target) {
		temp += "(" + val1 + c1 + val2 + ")" + "/" + "(" + a[2] + "" + a[3] + ")";
	}
